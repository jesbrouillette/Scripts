...
param(
    [string] $dataSource = $(Read-Host "Please specify a data source."),
    [string] $database = $(Read-Host "Please specify a database."),      
    [string] $sqlCommand = $(Read-Host "Please specify a query."),
	[switch] $winauth;
